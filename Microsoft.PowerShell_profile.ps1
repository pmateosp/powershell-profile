...
############                       https://github.com/pmateosp/powershell-profile.git.                               ############
############                                                                                                         ############
#!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!#
############                                                                                                         ############
...
function Update-Profile {
    ...
    try {
        $url = "https://raw.githubusercontent.com/pmateosp/powershell-profile/main/Microsoft.PowerShell_profile.ps1"
...
function Get-Theme {
    if (Test-Path -Path $PROFILE.CurrentUserAllHosts -PathType leaf) {
        ...
        oh-my-posh init pwsh --config https://raw.githubusercontent.com/JanDeDobbeleer/oh-my-posh/main/themes/rubrick_theme.omp.json | Invoke-Expression
    }
}
